...
const ContextforCart = ({children}) => {
    ...
    let REMOVE_ITEM_BY_INDEX=(index)=>{
        cart.splice(index,1)
        setCart([...cart])
    }
    let EMPTY_CART=()=>{
...
<DataContext.Provider value={{cart,total,ADD_TO_CART,INCREASE,DECREASE,REMOVE_ITEM_BY_ID,REMOVE_ITEM_BY_INDEX,EMPTY_CART,CALCULATE_TOTAL}}>
        {children}
    </DataContext.Provider>
 </>
  )
